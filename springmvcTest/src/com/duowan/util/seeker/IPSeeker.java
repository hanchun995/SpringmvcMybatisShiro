package com.duowan.util.seeker;
...
import com.duowan.util.seeker.LogFactory; 
...
public class IPSeeker { 
	...
	public static void main(String[] args) {
		...
		// IPSeeker ip = new IPSeeker("QQWry.Dat", realPath+"WEB-INF/classes");
		// java se项目环境
		String realPath = IPSeeker.class.getClass().getResource("/").getPath();
		IPSeeker ip = new IPSeeker("QQWry.Dat", realPath);
		System.out.println(
				ip.getIPLocation("222.186.130.139").getCountry() + ":" + ip.getIPLocation("222.186.130.139").getArea());
	}
